...
def benchmark_model(model_name, model_params, device):
    ...
    parameter counts match Table I."""
...
def main(args):
    ...
    # profile each backbone from its training config, in paper Table I order
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="Model profiler (params / latency / FLOPs). Reads hyperparameters "
                    "from the training YAMLs so the Params column matches Table I.")
